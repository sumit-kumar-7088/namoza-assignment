...
Front-End / GTM: Upon form submission, the vanilla JS immediately pushes the consultation_form_submitted event to the dataLayer. GTM listens for this and fires the Google Ads Conversion tag directly in the browser.

Data Payload: Simultaneously, the JS makes an asynchronous POST request to a Make Webhook URL containing the Name, Phone, and Clinic Preference.
